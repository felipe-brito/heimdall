...
public enum ExceptionMessage {
    ...
    /**
     * Method responsible for exception triggering with partial or total custom
     * message inclusion.
     *
     * @param dynamicText This parameter will replace the symbols: {}, included
     * in the message respectively. If more than one symbol is given: {}, and
     * only one parameter pass, it will replace all the keys for the parameter
     * entered.
     */
